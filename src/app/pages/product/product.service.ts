...
export class ProductService {
  ...
  private baseAPIUri = environment.applicationServerURL + "/products/v1";
  ...
  public saveProduct(product: ProductModel, processingEvent: EventEmitter<boolean>, resultEvent: EventEmitter<any>, error: EventEmitter<DataServerError[]>): void {
  ...
  public updateProduct(product: ProductModel, processingEvent: EventEmitter<boolean>, resultEvent: EventEmitter<any>, error: EventEmitter<DataServerError[]>): void {
  ...
  public  allProducts(processingEvent: EventEmitter<boolean>, resultEvent: EventEmitter<any>, error: EventEmitter<DataServerError[]>):void {
    const api = this.baseAPIUri + '/all';
    this.httpService.invokeGet(api, processingEvent, resultEvent, error, this.handleError);
  }
  public getProductByID(id: any, processingEvent: EventEmitter<boolean>, resultEvent: EventEmitter<any>, error: EventEmitter<DataServerError[]>): void {
